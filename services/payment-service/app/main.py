...
settings=get_settings(); app=FastAPI(title='AstraCart Payment Service', version='2.0.0')
...
@app.get('/health')
def health(): return {'success': True, 'message':'payment-service healthy','data':{'service':settings.service_name}}
